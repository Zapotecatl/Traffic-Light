...
Description: This program implement the algoritms of the Green Wave and Self Organization for control traffic ligths proposed by
...
int CityBuilding(int n_hor, int m_ver, int d_blk)
{
    ...
    //Sets values â€‹â€‹valid in the numbers of horizontal and vertical streets, and the distance of the blocks.
    if (n_hor < 1)
        n_hor_streets = 1;
    else
        n_hor_streets = n_hor;
